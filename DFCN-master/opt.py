...
parser.add_argument('--name', type=str, default="kyber")
...
parser.add_argument('--lr_kyberpublic', type=float, default=1e-4)
parser.add_argument('--lr_kyberpublictemp', type=float, default=1e-4)
parser.add_argument('--lr_kyber', type=float, default=1e-4)
